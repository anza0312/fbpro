...
export default function UserEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const editUser = await fetch('/api/user/create', {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            <title>Nugi Template :: Hapus Pengguna</title>
            <div className="min-h-screen bg-gray-100 p-6">
                <div className="container mx-auto px-4">
                    <h1 className="text-3xl font-semibold text-gray-800 mb-4">Tambah User</h1>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        >
                            {submited ? 'Proses...' : 'Tambah Pengguna'}
                        </button>
                        <button
                            type="button"
